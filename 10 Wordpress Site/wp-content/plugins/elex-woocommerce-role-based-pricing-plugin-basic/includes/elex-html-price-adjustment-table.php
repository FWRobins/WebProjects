...
<tr valign="top" >
    <td class="forminp" colspan="2" style="padding-left:0px">
        ...
        <table class="price_adjustment widefat" id="eh_pricing_discount_price_adjustment_options">
            ...
            <th style="text-align:center;"><?php _e('Remove', 'elex-catmode-rolebased-price'); ?></th>
        </thead>
        <tbody id='elex_rp_table_body'>
            ...
            foreach ($user_adjustment_price as $key => $value) {
                ...
                <tr>
                    ...
                    <td style="width: 15%;">
                        <select  data-placeholder="N/A" class="wc-enhanced-select" name="eh_pricing_discount_price_adjustment_options[<?php echo $key ?>][roles][]"  multiple="multiple" style="width: 25%;float: left;">
                            <?php
...
<script type="text/javascript">
    ...
    jQuery('#elex_rp_add_rule').click( function() {
        ...
        var categories = '<?php echo $category_options; ?>';
