						...
						<div class="wpallimport-upload-type-container" rel="url_type">						
							...
							<div class="wpallimport-note" style="margin: 20px auto 0; font-size: 13px;">
								...
								<div class="wpallimport-free-edition-notice" style="display:none;">									
									<a href="https://www.wpallimport.com/checkout/?edd_action=add_to_cart&download_id=1748&edd_options%5Bprice_id%5D=1&utm_source=import-plugin-free&utm_medium=upgrade-notice&utm_campaign=download-from-url" target="_blank" class="upgrade_link"><?php _e('Upgrade to the Pro edition of WP All Import to Download from URL', 'wp_all_import_plugin');?></a>
							...
							<div class="wpallimport-file-type-options">
								...
								<div class="wpallimport-note" style="margin: 0 auto; font-size: 13px;">
									...
									<div class="wpallimport-free-edition-notice">									
										<a href="https://www.wpallimport.com/checkout/?edd_action=add_to_cart&download_id=1748&edd_options%5Bprice_id%5D=1&utm_source=import-plugin-free&utm_medium=upgrade-notice&utm_campaign=use-existing-file" target="_blank" class="upgrade_link"><?php _e('Upgrade to the Pro edition of WP All Import to Use Existing Files', 'wp_all_import_plugin');?></a>
										<p><?php _e('If you already own it, remove the free edition and install the Pro edition.', 'wp_all_import_plugin'); ?></p>
									</div>
								</div>
							</div>
...
//											}
								...
								<div class="wpallimport-choose-import-direction">
									...
									<div class="wpallimport-upgrade-notice" rel="taxonomies">
										...
										<a href="https://www.wpallimport.com/checkout/?edd_action=add_to_cart&download_id=1748&edd_options%5Bprice_id%5D=1&utm_source=import-plugin-free&utm_medium=upgrade-notice&utm_campaign=import-taxonomies" target="_blank" class="upgrade_link"><?php _e('Purchase WP All Import Pro', 'wp_all_import_plugin');?></a>
									</div>
